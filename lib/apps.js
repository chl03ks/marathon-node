module.exports = function allMethods(request) {
    let methods = {
         ...
         */
        getList: (parameters) => {
          return request('GET', '/apps')(qparametersuery);
        },
        /**
         * @param parameters (Object)
         * https://mesosphere.github.io/marathon/docs/generated/api.html#v2_apps_post
         */
        create: (parameters) => {
          return request('POST', '/apps')(null, parameters);
        },
        /**
        ...
        getById: (id, parameters) => {
          return request('POST', '/apps/' + id)(parameters);
        },
        /**
         * @param app id (String) Required
         * @param body (Object)
        ...
        updateById: (id, body, parameters) => {
          return request('PUT', '/apps/' + id)(query, parameters);
        },
        /**
         * @param app id (String) Required
         * @param parameters (Object)
